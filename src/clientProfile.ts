...
const MOCK_CLIENTS: Record<string, ClientIdentity> = {
  'ernesto@apokonhardware.com.ph': {
    name: 'Ernesto Dela Vega', initials: 'ED', avatarColors: ['#ECFDF5', '#065F46'],
    business: 'Apokon Hardware MSME', barangay: 'Apokon',
    permit: 'DTI-REG-2024-08812', email: 'ernesto@apokonhardware.com.ph',
    verificationStatus: 'Verified',
  },
  'rvillanueva@davaofrutis.com.ph': {
    name: 'Ramon Villanueva', initials: 'RV', avatarColors: ['#EFF6FF', '#1E40AF'],
    business: 'Davao Fruits Corp.', barangay: 'Magugpo West',
    permit: 'DTI-REG-2024-08812', email: 'rvillanueva@davaofrutis.com.ph',
    verificationStatus: 'Pending Review',
  },
  'rcamacho@citymalltagum.com': {
    name: 'Rowena Camacho', initials: 'RC', avatarColors: ['#F5F3FF', '#5B21B6'],
    business: 'CityMall Tagum', barangay: 'Magugpo West',
    permit: 'DTI-REG-2022-11140', email: 'rcamacho@citymalltagum.com',
    verificationStatus: 'Verified',
  },
}
