...
function IconEye({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      <path
        d="M1.5 10S5 5.5 10 5.5 18.5 10 18.5 10 15 14.5 10 14.5 1.5 10 1.5 10z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
...
function IconEyeOff({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      <path
        d="M1.5 10S5 5.5 10 5.5c1.6 0 3 .5 4.2 1.4M6.1 7.2C4 8.5 2.5 10 2.5 10S6 14.5 10 14.5c1.3 0 2.6-.4 3.7-1.2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M7.7 7.9a2.5 2.5 0 003.4 3.4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function IconGraduation({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      <path
        d="M10 3L1 8l9 5 9-5-9-5z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M5 10v4c0 1.2 2.2 2.5 5 2.5s5-1.3 5-2.5v-4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M14 7.5V4l2-1.5v3.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
function IconBuilding({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      ...
      />
      <path
        d="M12 8h3v9h-3M6 6.5h3M6 9.5h3M6 12.5h3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function IconShieldKey({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      <path
        d="M10 2L3 4.5v5c0 3.7 3 7 7 8 4-1 7-4.3 7-8v-5L10 2z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
function IconShieldSmall({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" fill="none">
      <path
        d="M7 1.5l5 1.8v3.9c0 2.8-2 5.2-5 5.9-3-.7-5-3.1-5-5.9V3.3L7 1.5z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function IconUserCheck({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none">
      ...
      <path
        d="M2.5 17c0-3 2.5-5 6-5 1.2 0 2.3.3 3.2.8"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M12.5 15l2 2 3.5-3.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function BrandIllustration() {
  return (
    ...
    >
      ...
      {/* connection nodes */}
      <path
        d="M46 210c30-30 70-34 96-20M340 120c22-26 56-28 84-16"
        stroke="#FFFFFF"
        strokeOpacity="0.35"
        strokeWidth="1.5"
        strokeDasharray="4 6"
      ...
      <path
        d="M262 166h10M262 161h10M262 171h10"
        stroke="#2563EB"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      ...
      <path
        d="M38 288h22M42 281h14M42 295h14"
        stroke="#1D4ED8"
        strokeWidth="2"
        strokeLinecap="round"
      />
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(165deg, #2563EB 0%, #1D4ED8 55%, #1E3A8A 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(96,165,250,0.28), transparent 65%)",
          }}
        />
        ...
        >
          ...
          >
            A centralized platform for secure project bidding, milestone
            tracking, and verified PSITS portfolios.
          </p>
        </div>
        ...
        >
          ...
          <span>
            In partnership with St. Mary's College of Tagum, Inc. &amp; Regional
            PSITS Chapters.
          </span>
        </div>
      </div>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(165deg, #2563EB 0%, #1D4ED8 60%, #1E3A8A 100%)",
            ...
            {mode === "signin" ? (
              ...
              <form onSubmit={handleSignIn} noValidate>
                ...
                {notice && (
                  ...
                  >
                    <span
                      style={{ color: "#16A34A", lineHeight: 0, marginTop: 2 }}
                    >
                      <IconCheck size={14} />
                    </span>
                    <div
                ...
                >
                  ...
                  <Field icon={<IconUserCheck size={18} />}>
                    <input
                      ...
                      onChange={(e) => {
                        setRegister((s) => ({ ...s, idNumber: e.target.value }))
                        setError(null)
                      }}
                      style={{
                        width: "100%",
